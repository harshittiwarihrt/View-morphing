...
def fundamental_matrix(image1, image2):
    ...
    '''
    U is a array of size is 68*68
    D is a array of size 9
    V is a array of size 9*9

    SVD decomposes the matrix a into rotations U and V And D is the diagonal matrix 
    '''

    # extract column of the smallest singular value - the last column
    #last wala row chaiye humko...
    smallest = V[8, :].T
